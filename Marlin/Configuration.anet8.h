// below was grabbed from https://www.thingiverse.com/thing:2091529
...
#define STRING_CONFIG_H_AUTHOR "(Jay Wiggins, Anet config)" // Who made the changes.
...
#Recv : #define DEFAULT_Ki 3.88
#Recv : #define DEFAULT_Kd 273.84
